...
/**
 * Provides "Send email to role" rules action.
 *
 * @RulesAction(
 *   id = "rules_send_email_to_role",
 *   label = @Translation("Send email to role"),
 *   category = @Translation("System"),
 *   context = {
 *     "role" = @ContextDefinition("string",
 *       label = @Translation("Role to send to"),
 *       description = @Translation("Role drupal will send an email to."),
 *       multiple = FALSE,
 *     ),
 ...
 */
class SystemSendEmailToRole extends RulesActionBase implements ContainerFactoryPluginInterface {
   ...
   */
  protected function doExecute($role, $subject, $message, $reply = NULL, LanguageInterface $language = NULL) {
    ...
    foreach ($users as $user) {
      $recipients = $user->get('mail')->value;
